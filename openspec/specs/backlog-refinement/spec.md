## Purpose
Defines the `backlog refine` sub-mode that walks through unestimated tickets one at a time, checks Definition of Ready, and captures story-point estimates from the user.
