## Purpose
Defines how the skill detects, stores, and applies project type classification at init time, driving conditional behaviour for doc scaffolding, label bootstrap, and ticket content generation.
