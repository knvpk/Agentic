# Spec: service-templates

## Purpose

Defines the requirements for bundled service template assets within the `docker-modular-stack` skill. Covers which services must be included, how hardcoded values are replaced with placeholders, and how templates are applied when copied to a target project.
