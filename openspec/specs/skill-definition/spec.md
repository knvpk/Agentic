...
Defines the requirements for the `docker-modular-stack` skill definition file (`SKILL.md`), including its frontmatter conformance, discoverability, and the three operating modes (Scaffold, Add, Lint) that Claude activates based on user intent.
