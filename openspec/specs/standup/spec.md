## Purpose
Defines the `standup` mode that generates a zero-prompt three-section standup report from current ticket state: what I did, what I'll work on, and blockers.
