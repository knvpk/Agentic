...
Defines the lint workflow for the vibe-wiki skill: identifying orphan pages, stub pages, and index gaps, and logging a summary entry to `log.md` after each run.
